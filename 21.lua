...
function Neverlose_Main:Window(config)
    ...
    BuildDateText.Text = "Build type: <font color='rgb(9, 174, 255)'>"BETA TEST"</font>"
    ...
    BuildTypeText.Text = "Build type: <font color='rgb(9, 174, 255)'>"BETA TEST"</font>"
    ...
    spawn(function()
        ...
        oth1:Colorpicker("Background", Neverlose_Main.Theme.Custom.Background, function(t)
            Neverlose_Main.Theme.Custom.Background = t
        end)
        oth1:Colorpicker("Section", Neverlose_Main.Theme.Custom.Section, function(t)
            Neverlose_Main.Theme.Custom.Section = t
        end)
        oth1:Colorpicker("Element", Neverlose_Main.Theme.Custom.Element, function(t)
            Neverlose_Main.Theme.Custom.Element = t
        end)
        oth1:Colorpicker("Text", Neverlose_Main.Theme.Custom.Text, function(t)
            Neverlose_Main.Theme.Custom.Text = t
        end)
        oth1:Colorpicker("Glow", Neverlose_Main.Theme.Custom.Glow, function(t)
            Neverlose_Main.Theme.Custom.Glow = t
        end)

        oth2:Bind("Toggle Menu", function(t)
            MainFrame.Visible = t
        end, {
            {
        ...
        local Get_ALC = oth2:Toggle("Open Menu On Launch", function(t)
            On_Launch = t
            if On_Launch then
                writefile(Folder..'/On_Launch.json', Neverlose_Main.HttpService:JSONEncode({
                    ["On_Launch"] = true,
