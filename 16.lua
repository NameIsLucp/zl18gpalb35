...
function Neverlose_Main:Window(config)
    ...
    spawn(function()
        task.wait(.2)
        getgenv().LuaSection = TabsSec:TSection("Other")
        local Configs = LuaSection:Tab("Configs")
        local Sec1 = Configs:Section("Load Config")
        local Sec2 = Configs:Section("Create Config")
        local ee28 = Configs:Section("UI Color")
        local ee18 = Configs:Section("Keys")
        local mmm = LuaSection:Tab("111111")
        local ee1 = mmm:Section("UI Color")
        local ee2 = mmm:Section("Keys")
        ...
        ee2:Colorpicker("Background", Neverlose_Main.Theme.Custom.Background, function(t)
            Neverlose_Main.Theme.Custom.Background = t
        end)
        ee2:Colorpicker("Section", Neverlose_Main.Theme.Custom.Section, function(t)
            Neverlose_Main.Theme.Custom.Section = t
        end)
        ee2:Colorpicker("Element", Neverlose_Main.Theme.Custom.Element, function(t)
            Neverlose_Main.Theme.Custom.Element = t
        end)
        ee2:Colorpicker("Text", Neverlose_Main.Theme.Custom.Text, function(t)
            Neverlose_Main.Theme.Custom.Text = t
        end)
        ee2:Colorpicker("Glow", Neverlose_Main.Theme.Custom.Glow, function(t)
            Neverlose_Main.Theme.Custom.Glow = t
        end)

        ee1:Bind("Toggle Menu", function(t)
            MainFrame.Visible = t
        end, {
            {
        ...
        local Get_ALC = ee1:Toggle("Open Menu On Launch", function(t)
            On_Launch = t
            if On_Launch then
                writefile(Folder..'/On_Launch.json', Neverlose_Main.HttpService:JSONEncode({
                    ["On_Launch"] = true,
